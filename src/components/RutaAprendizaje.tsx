          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 items-start">
            ...
            <div className="min-w-0">
              ...
              <div className="relative mx-auto w-full overflow-x-hidden" style={{ maxWidth: 460, height: altura }}>
                ...
                <div className={`absolute z-10 -translate-x-1/2 -translate-y-1/2 transition-all duration-700 ease-out mt-5 lg:mt-8 ${
                  nodeIzq ? "left-[77%] lg:left-[78%]" : "left-[61%] lg:left-[54%]"
                }`}
                     style={{ top: octiY }}>
